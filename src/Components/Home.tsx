      ...
      <div className='flex flex-col gap-2.5'>
        ...
        <div 
          ...
          <motion.div 
            ...
            <div 
              className='text-white font-mono text-[2rem] flex flex-col absolute -left-[12rem]'>
              {(isHovered.firstContainer || hasBeenHovered.firstContainer) && (
                <motion.h1 
                  ...
                  viewport={{ once: true}}
                  className='flex justify-end text-[4rem] font-bold'>My
                </motion.h1> 
              )}          
              {(isHovered.firstContainer || hasBeenHovered.firstContainer) && (
                <motion.h1 
                  ...
                  viewport={{ once: true}}
                  className='flex justify-end text-[4rem] font-bold'>
                    Tech
                </motion.h1>  
              )}  
              {(isHovered.firstContainer || hasBeenHovered.firstContainer) && (
          ...
          <div className='flex flex-row-reverse absolute left-[77rem] text-white font-mono'>
            ...
            {(isHovered.secondContainer || hasBeenHovered.secondContainer) && (
                <motion.h1 
                  ...
                  viewport={{ once: true}}
                  className='flex justify-start text-[3.5rem] font-bold'>
                    My
                </motion.h1>  
              )}  
              {(isHovered.secondContainer || hasBeenHovered.secondContainer) && (
